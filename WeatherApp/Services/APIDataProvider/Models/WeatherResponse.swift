...
struct WeatherResponse: Decodable {
    ...
    init(from decoder: any Decoder) throws {
        ...
        self.snow = try container.decodeIfPresent(WeatherResponse.PrecipitationData.self, forKey: .snow)
        self.rain = try container.decodeIfPresent(WeatherResponse.PrecipitationData.self, forKey: .rain)
